 function parallelRightBottomMandatoryValidation(event){
	    		if(($('#parallelmodalprofile1,#parallelgrade1').prop('selectedIndex')) == 0) {
	    		...
	    		if(($('#pezcamber').prop("checked") == true) && ($('#pezcamber').prop('selectedIndex') )== 0){
	    			event.preventDefault();
	    		}
       ...
       var profiles="<option>"+value.Profile+"</option>";
         ...
         $.each(wsDropDown.Camber, function(index,data) {   
          var datasource="<option>"+data.Camber_fra+"</option>";
                $(datasource).appendTo('#pezcamber1'); 
         ...
         $("#parallelmodalprofile1").change(function(){
     		...
     		$.each(filtered, function(key, value) {
     		       var ConnectionMark="<option>"+value.connectionMark+"</option>";
     		         $(ConnectionMark).appendTo('#parallelconmark1'); 
     		         $(ConnectionMark).appendTo('#parallelconmark5'); 
     		   });
     		  $('#parallelconmark2').empty();
     			...
     			$.each(filtered, function(key, value) {
     			 ...
     			 $('#cgaxialload1').empty();
     			    $('#2cgaxialload10').empty();
     			    $('#3cgaxialload10').empty();
     			    $('#4cgaxialload10').empty();
     			    $('#5cgaxialload10').empty();
