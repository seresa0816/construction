    ...
    if(wsPlateGrade != null){
    	var plateGrades = wsPlateGrade.MemberGrades.Plates;
    	 if(plateGrades != null){
             ...
             $(plgrade).appendTo('#plategirder1').prop('selected', true); 
          }
		...
		$.each(wsDropDown.Inch, function(index,data) {   
		 ...
		 $('#colTop_in').val("0");
      	...
      	$('#colBottomEleTxt').keyup(function(e){
			$("#colBottomEleTxt").removeClass("importantRed");
			});
		$('#colTopEleTxt').keyup(function(e){
			$("#colTopEleTxt").removeClass("importantRed");
			});
		$('#columncount').keyup(function(e){
			$("#columncount").removeClass("importantRed");
			});
		$('#columnspacing1').keyup(function(e){
			$("#columnspacing1").removeClass("importantRed");
			});
		$('#cplatewidth1').keyup(function(e){
 			    ...
 			    function getCapPlateConnectionMark(){
 				  ...
 				  // if( $('#chkCap1').is(':disabled')){
 					   var filtered1 = $.grep(connectionObjList, function (el) {
 						   ...
 						   if(profilename.indexOf(el.profile) >= 0 && el.type.toLowerCase().indexOf("base")>=0 && el.baseplate.toLowerCase().indexOf("cap")>=0)
 						  {
 					        	return el.profile;
 				 ...
 				 var profilename = $("#columnprofile").val();	
 					...
 					if((spliceCount)>0){
 					  var cmsplice = $.grep(connectionObjList, function (el2) {
 							  ...
 							  if(el2.type.toLowerCase().indexOf("splicecolumn")>=0){
	                                  ...
	                                  <div class="col-lg-8 col-lg-8 padding10">
	                                      ...
	                                      <div class="row">
	                                          ...
	                                          <div class="col-lg-3 col-md-3 padding5">
	                                              <input type="text" class="form-control per70 " onkeypress = "return AllowNumbersOnly(event)" id="splice`+i+`Ft">
	                                              <div class="txt-right">
	                                                  ft
	                                              </div>
	                                          </div>
