		   ...
		   var noOfCoatsprimer = wsFinish.Finish.Primer.NoOfCoatsPrimer;
		      ...
		      $('#chkprimer').change(function() {
		          if($(this).prop("checked") == true){
		              ...
		              $('#bc3primer1, #bc3primer2').attr('disabled', true);
		          }
		      });
     ...
     var noOfCoatspaint = wsFinish.Finish.Paint.PaintValue[1].NoOfCoatsPaint;
      ...
      $('#chkpaint').change(function() {
          if($(this).prop("checked") == true){
              ...
              $('#bc3paint1, #bc3paint2').attr('disabled', true);
          }
          ...
          $('#bc3galvanization2').attr('disabled', true);
      });
      if(usedfinish == "Paint"){
...
$('#chkaess').change(function() {
    ...
    $('#bc3paint1, #bc3paint2, #bc3galvanization2, #bc3fireProofing2, #bc3fireProofing3').attr('disabled', true); 
});
 if(usedfinish == "AESS"){
	  ...
	  if(aessperiSPreparation != null){
 	   ...
 	   var fireProofingType = wsFinish.Finish.FireProofing.FireProofingType;
	      ...
	      $('#chkfireproofing').change(function() {
	          if($(this).prop("checked") == true){
	              ...
	              $('#bc3fireProofing2, #bc3fireProofing3').attr('disabled', true);
	          }  
	          if($('#chkprimer').prop("checked") == true){
	              $('#chkprimer').removeAttr("disabled");
	          } else {
	          ...
	          $('#bc3paint1, #bc3paint2, #bc3galvanization2, #bc3aess1').attr('disabled', true);  
	          // $('#chkprimer').removeAttr("disabled");
	      });
	   ...
	   var  zincCoatingThickness =  wsFinish.Finish.Galvanization.ZincCoatingThickness;
	      ...
	      $('#chkgalvanize').change(function() {
	          ...
	          $('#bc3primer1, #bc3primer2, #bc3paint1, #bc3paint2, #bc3fireProofing2, #bc3fireProofing3, #bc3aess1').attr('disabled', true);
	   ...
	   var	nopperiSPreparation = wsFinish.Finish.NoPaint.SSPC_No;
	    ...
	    $('#chknopaint').change(function() {
	        ...
	        $('#bc3paint1, #bc3paint2, #bc3galvanization2, #bc3fireProofing2, #bc3fireProofing3, #bc3aess1').attr('disabled', true);
	    });
...
//populate splice drop down
 ...
 // JQuery Code
  ...
  $(".bc3select1").select2({
    ...
    $('#bc3cbelevationft').keyup(function(e){
		$("#bc3cbelevationft").removeClass("importantRed");
		});
    $('#bc3ctelevationft').keyup(function(e){
		$("#bc3ctelevationft").removeClass("importantRed");
		});
    $('#bc3count').keyup(function(e){
		$("#bc3count").removeClass("importantRed");
		});
