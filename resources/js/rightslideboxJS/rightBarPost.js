	  ...
	  $(".postselect1").select2({
		...
		$('#chkcapplate').change(function() {
		 ...
		 $("#postProfile").change(function(){
		  	...
		  	$("#postTopElevationFt").keyup(function(e){
				$("#postTopElevationFt").removeClass("importantRed");
				});
		  	$("#postBottomElevationFt").keyup(function(e){
				$("#postBottomElevationFt").removeClass("importantRed");
				});
			$("#xDirectionFt").keyup(function(e){
				$("#xDirectionFt").removeClass("importantRed");
				});
			$("#yDirectionFt").keyup(function(e){
				$("#yDirectionFt").removeClass("importantRed");
				});
