function pitchedRightTopMandatoryValidation(event){
	    		if(($('#pitchedprofile,#pitchedgrade').prop('selectedIndex')) == 0) {
  ...
  $.each( wsDropDown.TopBottomChord, function(key, value) {
         ...
         $(profiles).appendTo('#pitchedprofile'); 
         		  ...
         		  var datasource="<option>"+data.MaterialGrade+"</option>";
                    $(datasource).appendTo('#pitchedgrade'); 
       ...
       $('.chosen-select-deselect').chosen({
            allow_single_deselect: true
              ...
              $("#tpitsplicecount").change(function() {
                  ...
                  var spliceCount=parseInt($("#tpitsplicecount option:selected").text());
                  $('.spliceprofile').empty();
                 
                  for(var i=1;i<=spliceCount;i++) {

                       var html=`
                           <div class="row nomarginlr traXsplice1">
                           <div class="col-lg-6 col-lg-6 padding10 ">
                               <label class="labelBlack control-label">Splice Position `+i+` From Left End</label>
                               <div class="row">

                                   <div class="col-lg-4 col-md-4">
                                       <input type="text" class="form-control per70" id="splicePositionLeftEndFt`+i+`">
                                       <div class="txt-right">
                                           ft
                                       </div>
                                   </div>
                           ...
                           <div class="col-lg-4">
                               ...
                               <select class="form-control spliceprofile" id="pitchedprofile`+i+`">
