   ...
   $.each( wsDropDown.BeamProfile, function(key, value) {
      ...
      $.each(wsDropDown.WeldSize, function(index,data) {   
          ...
          $.each(wsDropDown.Fraction, function(index,data) {   
            ...
            $('<option>').val(data.fr).text(data.fr_fra).appendTo('#pbtosfr7,#pbtosfr8,#peribeamffl_fra4,#peribeamffl_fra5,#pbtosfr9,#pbtosfr10,#pbtosfr11,#pbtosfr12,#pbtosfr3,#pbtosfr4,#pbtosfr5,#pbtosfr6,#peribeamffl_fra,#pbtosfr2,#pbtosfr1,#peribeamffl_fra1,#ispacing2fr,#itosfr,#ifflfr,#ispacing1fr');
           
           
        });
          
        $.each(wsDropDown.Inch, function(index,data) {   
             $('<option>').val(data.Inch).text(data.Inch).appendTo('#pbtosin7,#pbtosin8,#peribeamffl_in4,#peribeamffl_in5,#pbtosin1,#peribeamffl_in,#pbtosin2,#peribeamffl_in1,#pbtosin3,#pbtosin4,#pbtosin5,#pbtosin6,#pbtosin9,#pbtosin10,#pbtosin11,#pbtosin12,#ispacing2in,#itosin,#ifflin,#ispacing1in');
        });
      ...
      function getGradeOnProfileChange(){
    	  var profilename = $(infillbeamprofile).val();
    ...
    function getProfileConnectionMark(){
		...
		$.each(filtered, function(key, value) {
 		...
 		$("#rightinfillbeamconntab").click(function() {  
...
*/
   ...
   // $(function() {
        ...
        $(".hideAll").hide();
        $("#infillbeamalignment").change(function() {

            if ($('#infillbeamalignment').val() == 'Straight') {
                $(".efieldsFW").show();
                $(".efieldsFB").hide();
                $(".einXsplice1").hide();
                $(".einXsplice2").hide();
            ...
            } else if ($('#infillbeamalignment').val() == 'Skewed') {
                $(".skewed").show();
                $(".efieldsFB").hide();
                $(".efieldsFW").show();
                $(".einXsplice1").hide();
