...
$.each(cmsplice, function(key, value) {
	...
	<input type="text" class="form-control per70 " id="splice`+i+`Ft">
	<div class="txt-right">
	ft
	</div>
	</div>
	...
	<input type="text" class="form-control per70 splicefeetWidth" placeholder="" id="splice`+i+`TFPlateWidthFt" onkeypress = "return AllowNumbersOnly(event)">
	<div class="txt-right">
	ft
	</div>
	</div>
	...
	<div class="row ">
	<div class="col-lg-4 col-md-4 p-r-5">
	<input type="text" class="form-control per70 splicefeetWidth" placeholder="" disabled="true" id="splice`+i+`BFPlateWidthFt">
	<div class="txt-right">
	ft
	</div>
	</div>
	...
	<div class="row ">
	<div class="col-lg-4 col-md-4 p-r-5">
	<input type="text" class="form-control per70 splicefeetWidthWeb" placeholder=""  id="splice`+i+`WebPlateWidthFt" onkeypress = "return AllowNumbersOnly(event)">
	<div class="txt-right">
	ft
	</div>
	</div>
		 ...
		 $('body').on('keyup', '.splicefeetWidth', function() {
			...
			$('#bc2wpthicknessin,#bc2wpthicknessfr,#bc2wpwidthin,#bc2wpwidthfr,#bc2tfpthicknessin,#bc2tfpthicknessfr,#bc2tfpwidthft,#bc2tfpwidthin,#bc2tfpwidthfr').change(function() {
			 ...
			 $("#boxcolumngrade").change(function(){
				...
				$('#bc2tfpwidthft').keyup(function(e){
					$("#bc2tfpwidthft").removeClass("importantRed");
					});
				$('#bc2wpwidthft').keyup(function(e){
					$("#bc2wpwidthft").removeClass("importantRed");
					});
				$('#bc2cbelevationft').keyup(function(e){
					$("#bc2cbelevationft").removeClass("importantRed");
					});
				$('#bc2ctelevationft').keyup(function(e){
					$("#bc2ctelevationft").removeClass("importantRed");
					});
