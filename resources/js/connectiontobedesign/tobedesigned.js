/*
$(".ConventionalShearPlate").hide();
$(".ExtendedShearPlate").hide();
$(".EndPlate").hide();  
$(function(){
    $("#cse").change( function(){
        ...
        else if($('#cse').val()=='Conventional Shear Plate'){  
            $(".ClipAngle").hide();
            $(".ConventionalShearPlate").show();
            $(".ExtendedShearPlate").hide();
            $(".EndPlate").hide();
        } 
        else if($('#cse').val()=='Extended Shear Plate'){  
            $(".ClipAngle").hide();
            $(".ConventionalShearPlate").hide();
            $(".ExtendedShearPlate").show();
            $(".EndPlate").hide();
        } 
