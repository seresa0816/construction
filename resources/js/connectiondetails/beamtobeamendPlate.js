...
$(".select2").select2(); 
    ...
    $("#edit").click(function(){
    	...
    	if (i==1) {
			...
			var index = listvalues.indexOf($row.find("td:nth-child(3)").text().replace(/\s/g, "").toLowerCase());
        ...
        $("#btocEndPlate").change( function(){
            ...
            if($('#btocEndPlate').val()=='Field Bolted'){ 
                ...
                getWelddetails();
            	  ...
            	  $("#eWeldDetails,#eBoltDetails").hide();
    	  ...
    	  var connectionjson=	tableToJSON('table') ;
    		$.ajax({
     		   type : 'POST',
     	          ...
     	          data : {connectiongrouptype:"BeamToBeamEndPlate",connectiontype:'0',connectionjson:JSON.stringify(connectionjson)},
    ...
    $(".contxt").each(function(){			
		  ...
		  connectionmarkvalues.push($('#conmark').val());
			...
			$.ajax({
	 		   type : 'POST',
	 	          ...
	 	          data : {connectiongrouptype:"BeamToBeamEndPlate",connectiontype:'0',connectionMarkjson:JSON.stringify(connectionmarkvalues)},
	 	          success : function(data, success) {
	 	        	var status=data;
	  ...
	  function updateconnectionmark() {
			        	  ...
			        	  $.ajax({
							   type : 'POST',
						          url: "/bimspring/deleteconnectionmark",	          
						           data : {connectiongrouptype:"BeamToBeamEndPlate",connectiontype:'0',connectionMarkjson:JSON.stringify(deleteconmarkval)},
        ...
        $("#btnDeleteRows").click(function() {
	       ...
	       deleteconnectionmarks("BeamToBeamEndPlate")
