  	  ...
  	  var connectionjson=	tableToJSON('table') ;
  		$.ajax({
   		   type : 'POST',
   	          ...
   	          data : {connectiongrouptype:"BeamToBeamShearPlate",connectiontype:'0',connectionjson:JSON.stringify(connectionjson)},
		  ...
		  connectionmarkvalues.push($('#conmark').val());
			...
			$.ajax({
	 		   type : 'POST',
	 	          ...
	 	          data : {connectiongrouptype:"BeamToBeamShearPlate",connectiontype:'0',connectionMarkjson:JSON.stringify(connectionmarkvalues)},
	 	          success : function(data, success) {
	 	        	var status=data;
				        	  ...
				        	  $.ajax({
								   type : 'POST',
							          url: "/bimspring/deleteconnectionmark",	          
							           data : {connectiongrouptype:"BeamToBeamShearPlate",connectiontype:'0',connectionMarkjson:JSON.stringify(deleteconmarkval)},
...
deleteconnectionmarks("BeamToBeamShearPlate")
