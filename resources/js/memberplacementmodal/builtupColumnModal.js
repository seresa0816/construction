  ...
  $( document ).ready(function() {
	  ...
	  getCapPlateConnectionMark();
        ...
        if(wsPlateGrade != null){
        	var plateGrades = wsPlateGrade.MemberGrades.Plates;
        	 if(plateGrades != null){
                 var plgrade="<option value>"+plateGrades+"</option>";
                 $(plgrade).appendTo('#bc1plategrade').prop('selected', true); 
              }
     ...
     $.each( wsDropDown.ChannelProfile, function(key, value) {
         ...
         var profiles="<option>"+value.Profile+"</option>";
               ...
               $(profiles).appendTo('#modalcolumn1profile2'); 
               $(profiles).appendTo('#columnmodal1profile'); 
               $(profiles).appendTo('#columnmodal1profile2'); 
	...
	$.each(wsDropDown.Inch, function(index,data) {   
		  ...
		  $('<option>').val(data.Inch).text(data.Inch).appendTo('#bc1platewidthin');
	 ...
	 $('#bc1platelengthin').val("0");
		    ...
		    $.each(wsDropDown.Fraction, function(index,data) {   
			  ...
			  $('#bc1platelengthfr').val("0");
			    ...
			    $.each(wsDropDown.WeldType, function(index,data) {   
		     		  var weldtype = "<option>"+data.wtype+"</option>";
		     		  $(weldtype).appendTo('#columnmodal1weldtype'); 
		     		 $(weldtype).appendTo('#columnmodal1weldtype1'); 
		     		});
		     	  $.each(wsDropDown.WeldSize, function(index,data) {   
		     		  var weldsize = "<option>"+data.weld_fra+"</option>";
		     		  $(weldsize).appendTo('#columnmodal1weldsize'); 
		     		 $(weldsize).appendTo('#columnmodal1weldsize1'); 
		     	 ...
		     	 var builtup = "<option>"+"Built-Up Column"+"</option>"
	                $(builtup).appendTo('#bc1columntype').prop('selected', true); 
		     	 ...
		     	 $.each(RefDwgNumFiles, function(index,data) { 
						...
						var referencenum="<option>"+data+"</option>";
				         ...
				         $(referencenum).appendTo('#bc1referencenumber'); 
...
var html=`  <div class="row">
    ...
    $("#ddlbuiltup1").change(function() {
        if ($('#ddlbuiltup1').val() == 'Directly welded') {
            $('#divDirectlyWelded').show();
            $('#divStiffnerPlate').hide();
            $('#singlewsp').hide();
        } else if ($('#ddlbuiltup1').val() == 'Stiffener Plate') {
            $('#singlewsp').show();
            $('#divStiffnerPlate').show();
	...
	$('#bc1baseelevationft').on('click', function() {
		   if( $('#bc1baseelevationft').val() == "0") {
		   $('#bc1baseelevationft').val("");
		   }
	   });
	$('#bc1topelevationft').on('click', function() {
		   if( $('#bc1topelevationft').val() == "0") {
		   $('#bc1topelevationft').val("");
		   }
	   });
	$('#bc1count').on('click', function() {
		   if( $('#bc1count').val() == "0") {
		   $('#bc1count').val("");
		   }
	   });
	$('#bc1platelengthft').on('click', function() {
		   if( $('#bc1platelengthft').val() == "0") {
		   $('#bc1platelengthft').val("");
		   }
	   });

	$('#bc1platewidthft').on('click', function() {
		   if( $('#bc1platewidthft').val() == "0") {
		   $('#bc1platewidthft').val("");
		   }
	   });