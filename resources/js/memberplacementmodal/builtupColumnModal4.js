 ...
 $('#chkaess').change(function() {
  ...
  if(usedfinish == "AESS"){
		   		             ...
		   		             var html=` <div class="row">
		   		                                <div class="col-lg-8 col-lg-8 padding10 ">
		   		                                    ...
		   		                                    <div class="row">
		   		                                        ...
		   		                                        <div class="col-lg-2 col-md-2 padding5">
		   		                                            <input type="text" class="form-control per70" id="splice`+i+`Ft" onkeypress = "return AllowNumbersOnly(event)" placeholder="0" onfocus="this.placeholder = ''" onblur="this.placeholder = '0'">
		   		                                            <div class="txt-right">
		   		                                                ft
		   		                                            </div>
		   		                                        </div>
		   		                            ...
		   		                            <div class="row" id="boxProfile1">
		   		                                <div class="col-lg-3 col-md-3 padding10 ">
		   		                                     ...
		   		                                     <div class="row ">
		   		                                        <div class="col-lg-4 col-md-4 p-r-5">
		   		                                            <input type="text" class="form-control per70 splicetextDepth" id="splice`+i+`DepthAFt" onkeypress = "return AllowNumbersOnly(event)" placeholder="0" onfocus="this.placeholder = ''" onblur="this.placeholder = '0'">
		   		                                            <div class="txt-right">
		   		                                                ft
		   		                                            </div>
		   		                                        </div>
		   		                                ...
		   		                                <div class="col-lg-3 col-md-3 padding10 ">
		   		                                     ...
		   		                                     <div class="row">
		   		                                        <div class="col-lg-4 col-md-4 p-r-5">
		   		                                            <input type="text" class="form-control per70 splicetextWidth" id="splice`+i+`WidthBFt" onkeypress = "return AllowNumbersOnly(event)" placeholder="0" onfocus="this.placeholder = ''" onblur="this.placeholder = '0'">
		   		                                            <div class="txt-right">
		   		                                                ft
		   		                                            </div>
		   		                                        </div>
	...
	$("#boxcolumnweld").change(function(){
		$("#boxcolumnweld").removeClass("importantRed");
		});
	$("#fillet").change(function(){
		$("#fillet").removeClass("importantRed");
		});
	 ...
	 $('#bc4widthbft').on('click', function() {
		   if( $('#bc4widthbft').val() == "0") {
		   $('#bc4widthbft').val("");
		   }
	   });
	 $('#bc4bcbelevationft').on('click', function() {
		   if( $('#bc4bcbelevationft').val() == "0") {
		   $('#bc4bcbelevationft').val("");
		   }
	   });
	 $('#bc4bctelevationft').on('click', function() {
		   if( $('#bc4bctelevationft').val() == "0") {
		   $('#bc4bctelevationft').val("");
		   }
	   });
