					...
					$("#hBraceProfile")
							.change(
									function() {
										...
										$.each(profileGrades, function(index,
												data) {
											var grades = "<option value=\""
													+ data.Grade + "\">"
													+ data.Grade + "</option>";
										...
										$.each(filtered, function(key, value) {
											...
											var ConnectionMark = "<option>"
													+ value.connectionMark
													+ "</option>";
											$(ConnectionMark).appendTo(
													'#hBraceMark1');
											$(ConnectionMark).appendTo(
													'#hBraceMark2');
											$(ConnectionMark).appendTo(
										...
										var connectionmark = $("#hBraceMark1")
												.val();
										if (connectionmark != null) {
											...
											$.each(conntype, function(key,
													value) {
												var supportbeam = "<option>"
														+ value.conntype
														+ "</option>";
												$(supportbeam).appendTo(
														'#hBraceTypeBeam1');
												$(supportbeam).appendTo(
														'#hBraceTypeBeam2');
												$(supportbeam).appendTo(
...
$('#hBraceLocation').on('click', function() {
	   if( $('#hBraceLocation').val() == "0") {
	   $('#hBraceLocation').val("");
	   }
  });
