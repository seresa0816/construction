...
$('#tracamber').change(function() {
    document.getElementById('tracamber1').disabled = !this.checked;
});
$('#pezcamber').change(function() {
    document.getElementById('pezcamber1').disabled = !this.checked;
});

$('#chkinclined').change(function() {
    document.getElementById('parainclined').disabled = !this.checked;
    document.getElementById('parainclined1').disabled = !this.checked;
    document.getElementById('parainclined2').disabled = !this.checked;
    document.getElementById('parainclined3').disabled = !this.checked;
});
// Verticals
$(".showtv1").hide();
$(".showtv2").hide();
